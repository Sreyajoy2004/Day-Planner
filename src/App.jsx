...
return ( <div className="relative min-h-dvh bg-gradient-to-br from-[#FFF7F0] via-[#FFFDF9] to-[#FFE8EF] p-6 flex justify-center items-start overflow-hidden">
  ...
  <div className="flex justify-center gap-2 mt-5">
    ...
    <div className="flex flex-col sm:flex-row gap-3 mb-6">
      <input
        ...
        className="flex-1 border border-pink-200 rounded-xl px-4 py-3"
      />

      <button
        onClick={addTask}
        className="bg-gradient-to-r from-[#E88BA8] to-[#D96C92] text-white px-6 rounded-xl"
      >
        Add
      </button>
    </div>
    <div className="flex flex-col sm:flex-row gap-3 mb-6">
      <input
       ...
       className="border border-pink-200 rounded-xl px-4 py-2"
     />
...
<input
  ...
  className="w-full border border-pink-200 rounded-xl px-4 py-2 mb-4"
/>
          ...
          >
            {(provided) => (
              <div
                ...
                className="flex flex-col sm:flex-row sm:items-center justify-between bg-[#FFF4F7] p-4 rounded-2xl border border-pink-100 hover:shadow-md transition"
              >
